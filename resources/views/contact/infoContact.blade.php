<section class="contact-section py-20 bg-gray-50" id="contact">
    <div class="container mx-auto px-4">
        <!-- Map Image -->
        <div class="mb-12 flex justify-center zoom-in-scroll">
            <img src="{{ asset('img/contact/peta.png') }}" alt="Location Map" class="w-full max-w-4xl h-auto">
        </div>

        <div class="flex flex-col md:flex-row gap-12 max-w-6xl mx-auto">
            
            <!-- Contact Info (Left Side) -->
            <div class="w-full md:w-5/12 pt-8 fade-in-left" data-aos="fade-right">
                ...
                <!-- Location Tabs -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden scale-in animate-delay-200">
                    <!-- Tab Headers -->
            ...
            <div class="w-full md:w-7/12 fade-in-right animate-delay-300" data-aos="fade-left" data-aos-delay="200">
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    <form action="{{ route('contact.send') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <!-- Name -->
                            <div class="fade-in-up animate-delay-100">
                                <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Full Name</label>
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#2a3891] focus:bg-white focus:ring-0 transition-all duration-300 outline-none focus:shadow-lg" placeholder="John Doe">
                            </div>
                            
                            <!-- Email -->
                            <div class="fade-in-up animate-delay-200">
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                                <input type="email" id="email" name="email" value="{{ old('email') }}" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#2a3891] focus:bg-white focus:ring-0 transition-all duration-300 outline-none focus:shadow-lg" placeholder="john@example.com">
                            </div>
                        </div>

                        <!-- Subject -->
                        <div class="fade-in-up animate-delay-300">
                            <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Subject</label>
                            <input type="text" id="subject" name="subject" value="{{ old('subject') }}" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#2a3891] focus:bg-white focus:ring-0 transition-all duration-300 outline-none focus:shadow-lg" placeholder="How can we help?">
                        </div>

                        <!-- Message -->
                        <div class="fade-in-up animate-delay-400">
                            <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                            <textarea id="message" name="message" rows="4" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#2a3891] focus:bg-white focus:ring-0 transition-all duration-300 outline-none resize-none focus:shadow-lg" placeholder="Write your message here...">{{ old('message') }}</textarea>
                        </div>

                        <!-- Submit Button -->
                        <button type="submit" class="w-full bg-[#2a3891] text-white font-medium py-3.5 rounded-lg hover:bg-[#1e2a6e] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 scale-in animate-delay-500">
                            Send Message
                        </button>
                    </form>
                </div>
