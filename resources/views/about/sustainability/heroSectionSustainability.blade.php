<style>
    #heroImageSustainability {
        opacity: 0;
    }
    #heroImageSustainability.loaded {
        opacity: 1;
...
<script>
    (function() {
        const image = document.getElementById('heroImageSustainability');
