<style>
    #heroImageCodeOfConduct {
        opacity: 0;
    }
    #heroImageCodeOfConduct.loaded {
        opacity: 1;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const image = document.getElementById('heroImageCodeOfConduct');
